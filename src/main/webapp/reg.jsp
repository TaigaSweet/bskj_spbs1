    ...
    <div class="xiao-register-box">
        ...
        <div class="xiao-userPassword-box">
            ...
            <div class="xiao-userPassword-input">
                <input type="password" id="userPassword" required="required" name="password"
                       placeholder="请输入密码 长度:6-12个字符"/>
        ...
        <div class="xiao-userRePassword-box">
            ...
            <div class="xiao-userRePassword-input">
                <input type="password" id="userRePassword" required="required" name="userRePassword"
                       placeholder="请重复输入密码"/>
        ...
        <div class="xiao-userEmail-box">
            ...
            <div class="xiao-userEmail-input">
                <input type="text" id="userEmail" required="required" name="email"
                       placeholder="请输入您的邮箱地址，如：123@qq.com"/>
